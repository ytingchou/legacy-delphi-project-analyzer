...
class TaskStudioTask:
    ...
    status: str = "prepared"
    context_budget_tokens: int = 0
    context_size_hint: str = "small"
    prompt_file: str | None = None
    fallback_prompt_file: str | None = None
    verification_prompt_file: str | None = None
    compiled_context_file: str | None = None
    response_template_file: str | None = None
    vscode_prompt_file: str | None = None
...
class AnalysisOutput:
    ...
    patch_apply_manifest: dict[str, Any] | None = None
